...
namespace Simple.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductsController : Simple.Web.Controllers.ProductsController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Simple.Web.Models.ProductViewModel product);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Simple.Web.Models.ProductViewModel product)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Simple.Web.Models.ProductViewModel product);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Simple.Web.Models.ProductViewModel product)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "product", product);

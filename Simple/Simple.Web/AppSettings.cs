...
namespace Simple.Web
{
    ...
    {
        public static string webpages_Version { get { return GetConfigSettingItem("webpages:Version"); } }    public static string webpages_Enabled { get { return GetConfigSettingItem("webpages:Enabled"); } }    public static string ClientValidationEnabled { get { return GetConfigSettingItem("ClientValidationEnabled"); } }    public static string UnobtrusiveJavaScriptEnabled { get { return GetConfigSettingItem("UnobtrusiveJavaScriptEnabled"); } }    public static string Komsky_FullApplicationName { get { return GetConfigSettingItem("Komsky:FullApplicationName"); } }    public static string Komsky_ShortApplicationName { get { return GetConfigSettingItem("Komsky:ShortApplicationName"); } }        private const string MISSING_CONFIG = "Invalid configuration. Required AppSettings section is missing";
